...
pub struct RepositoryHandlerImpl<'d, D: InfraHandler> {
    image_info_repository: ImageInfoRepositoryImpl<'d, D::ImageInfoApi>,
}

impl<'d, D: InfraHandler> RepositoryHandlerImpl<'d, D> {
    pub fn new(handler: &'d D) -> Self {
        let image_info_repository = ImageInfoRepositoryImpl::new(handler.file_accessor());
        Self {
...
impl<'d, D: InfraHandler> RepositoryHandler for RepositoryHandlerImpl<'d, D> {
    type ImageInfo = ImageInfoRepositoryImpl<'d, D::ImageInfoApi>;
